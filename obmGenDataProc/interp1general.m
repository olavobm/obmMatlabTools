classdef interp1general
    % Class INTERP1GENERAL defined to make it easy to do 1D interpolation
    ...
    %
    %   obj = INTERP1GENERAL(x, y)
    %
    % which creates a variable obj of class INTERP1GENERAL. Then do:
    %
    %	obj.interpxy(xi, yi)
    %
    ...
    methods
        ...
        function obj = interp1general(x, y, baseperiod)
            %% obj = INTERP1GENERAL(x, y, baseperiod)
            %
            %   inputs:
            ...
            %
            %   output:
            %       - obj: object of class INTERP1GENERAL with the

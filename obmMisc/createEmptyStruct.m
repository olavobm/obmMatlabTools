function outstruct = createEmptyStruct(listfields, n)
% outstruct = CREATEEMPTYSTRUCT(listfields, n)
%
%   inputs:
...
%                    fields listfields.
%
% Function CREATEEMPTYSTRUCT creates an empty structure of size n

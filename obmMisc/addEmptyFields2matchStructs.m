...
% number of fields and with the same names. ADDEMPTYFIELDS2MATCHSTRUCTS
% compares the field names of both inputs. Fields that exist in one
% input but not the other are added to later. The content in this newly
% created field is an empty (double) variable.
% 

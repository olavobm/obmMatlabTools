...
% [uvtrans] = ARROWPLOTTRANSFORM(uv, lenhei, xyran, xy0, rotang)
% 
%   inputs
...
%       - xy0: 2xN array with vector tail positions,
%              in the coordinate system of xyran.
%       - rotang: 1xN rotation angle, in radians, for an additional
%                 counterclockwise rotation of the vectors uv.
%
% Transform the vectors uv from their coordinate system to
% the coordinate system of xyran taking into account the
% aspect ratio defined by lenhei. In other words, the argument
% of a vector uv is the same as the appearance of uvtrans in a
% plot with aspect ratio defined by the length lenhei(1) and
% height lenhei(2).
%
